...
export type AgentMission = {
  id: string; version: number; objective: string; provider?: string; model?: string; workspace?: string; project_id?: string; organization_id?: string;
...
export const createMission = (payload: { objective: string; provider?: string; model?: string; project_id?: string; workspace?: string; auto_run?: boolean }) => agentFetch<AgentMission>("/api/agent/v1/missions", { method: "POST", body: JSON.stringify(payload) });
